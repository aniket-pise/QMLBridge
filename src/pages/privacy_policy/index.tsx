...
import { title, description, privacy_policy } from './data';
import { ColorsPalette } from '../../utils/constants/colors';

/**
 * PrivacyPolicyPage component displays the privacy policy of the service.
 * It features a responsive layout with modern card-based sections that adapt dynamically.
 * 
 * This page:
 * - Displays privacy policy content in visually distinct, collapsible sections
 ...
 * - Provides clear visual hierarchy between main sections and sub-sections
 */
			...
			children={(
				<main style={{
					...
					<section style={{
						...
						{/* Iterate through the privacy_policy array and display each section */}
