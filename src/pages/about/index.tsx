...
import { description, features, title } from './data';
import { ColorsPalette } from '../../utils/constants/colors';

/**
 * AboutPage component displays information about QMLBridge and its features.
			...
			children={(
				<main style={{
					...
					<section style={{
						...
						{/* Description text about the QtBridge-to-QML converter */}
						<p style={{
							fontSize: '12px',
					...
					<section style={{
						...
						{features.map((feature, index) => {
							const featureColor = sectionColors[index % sectionColors.length];
							return (
								<div
									key={index}
									style={{
