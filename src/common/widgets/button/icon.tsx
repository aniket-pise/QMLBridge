...
const IconButton: FC<IconButtonProps> = ({
	...
	const buttonStyle: ButtonStyle = {
		...
		mouseCursor: 'pointer',
		borderRadius: 8,
		primaryColor: colors.Solid600,
		hoverColor: colors.Solid500,
		activeColor: colors.Solid400,
		disabledColor: colors.Solid400,
		focusColor: colors.Solid400,
		overlayColor: colors.Solid300A,
		outline: {
			width: 2,
			style: 'solid',
	...
	// Handles the mouse enter event, setting hover state to true when the mouse enters the button
	const handleMouseEnter = () => toggleHover(true);

	// Handles the mouse leave event, setting hover state to false when the mouse leaves the button
	const handleMouseLeave = () => toggleHover(false);
	...
	const getBorderColor = () => {
		...
		// Return the hover color if the button is currently active (pressed) or hovered
		if (isActive) return buttonStyle.hoverColor;
		if (isHovered) return buttonStyle.hoverColor;
	...
	return (
      ...
      */}
			...
			{/* 
        This renders any child components or content that are passed to the IconButton component.
      ...
      */}
          ...
          .filled-button:focus-visible:hover {
            outline: none;
          }
