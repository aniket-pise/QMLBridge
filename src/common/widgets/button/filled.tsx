...
const FilledButton: FC<FilledButtonProps> = ({
	...
	const buttonStyle: ButtonStyle = {
		...
		mouseCursor: 'pointer',
		borderRadius: 8,
		primaryColor: isDarkMode ? ColorsPalette.Lime600 : ColorsPalette.Lime400,
		hoverColor: isDarkMode ? ColorsPalette.Lime700 : ColorsPalette.Lime300,
		activeColor: isDarkMode ? ColorsPalette.Lime800 : ColorsPalette.Lime200,
	...
	return (
      ...
      */}
			...
			{/* 
        This renders any child components or content that are passed to the FilledButton component.
